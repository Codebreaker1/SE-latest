...
WHERE tests.test_ID =$ms
AND test_records.remark LIKE '$select'
...
$T=mysql_query("Select Test_Name from tests WHERE test_ID= $ms");
$tes=mysql_fetch_array($T);
echo "<h1> Lifestyle of people with ".$select." ".$tes[0]."</h1>";
echo "<table border='1'>
<tr>
<th>Factor</th>
<th>question</th>
